...
export function Pricing() {
    ...
    return (
        <section className="pt-16 sm:pt-20 sm:pb-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-yellow-100">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-black mb-2 sm:mb-3 lg:mb-6 leading-tight tracking-wide uppercase">
                ...
                {user && user.role === "STUDENT" && subscription && (
                    <div className="mb-8 text-center">
                        <div className="inline-block bg-green-300 text-black px-6 py-3 border-3 border-black shadow-[4px_4px_0px_0px_black] font-black uppercase tracking-wide mb-14">
